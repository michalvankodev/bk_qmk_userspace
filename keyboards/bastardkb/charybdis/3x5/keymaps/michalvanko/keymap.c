...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    ...
    KC_DQT,  KC_DLR, KC_PERC, KC_CIRC, KC_PLUS, ______________HOME_ROW_GACS_R______________, \
...
#define LAYOUT_LAYER_GAMEPAD_L1                                                                     \
       ...
       KC_TRNS,    KC_1,    KC_2,    KC_3,    KC_0,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, \
                      MO(LAYER_GAMEPAD_L1), SPC_NAV, XXXXXXX, ENT_SYM, BSP_NUM
...
#define LAYOUT_LAYER_GAMEPAD_L2                                                                     \
       ...
       KC_TRNS,    KC_F1,    KC_F2,    KC_F3,    KC_0,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, \
                      XXXXXXX, SPC_NAV, MO(LAYER_GAMEPAD_L2), ENT_SYM, MO(LAYER_GAMEPAD_L2)
...
const uint16_t PROGMEM colemak_combo[] = {KC_Q, KC_P, COMBO_END};
const uint16_t PROGMEM qwerty_combo[] = {KC_Q, KC_SCLN, COMBO_END};
combo_t key_combos[] = {
